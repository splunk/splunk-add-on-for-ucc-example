...
class AlertPage(Page):
    def __init__(
        ...
        super(AlertPage, self).__init__(
            ucc_smartx_selenium_helper, ucc_smartx_rest_helper, open_page
        )
    ...
    def open(self):
        ...
        """
        self.browser.get(
            self.splunk_web_url + "/en-US/manager/Splunk_TA_UCCExample/saved/searches"
        )

    def _get_alert_endpoint(self):
        return "{}/servicesNS/admin/Splunk_TA_UCCExample/saved/searches/".format(
