...
class Logging(Entity):
    def __init__(self, browser, urls, session_key):
        ...
        self.log_level = SingleSelect(
            browser, {"by": By.CSS_SELECTOR, "select": ".loglevel"})
    ...
    def open(self):
        ...
        """
        self.browser.get(
            '{}/en-US/app/Splunk_TA_UCCExample/configuration'.format(self.web_url))
    ...
    def _get_logging_url(self):
        ...
        """
        return '{}/servicesNS/nobody/Splunk_TA_UCCExample/configs/conf-splunk_ta_uccexample_settings/logging'.format(self.mgmt_url)
