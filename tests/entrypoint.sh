...
/home/circleci/work/tests/sc-4.4.12-linux/bin/sc -bqc -u ta-factory-01 -k be7beeab-8bba-420c-90b3-8eac2d16d3ca --doctor
wget --retry-connrefused --no-check-certificate -T 6 -bqc localhost:4445
